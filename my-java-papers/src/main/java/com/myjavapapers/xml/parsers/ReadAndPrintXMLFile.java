...
public class ReadAndPrintXMLFile{
    ...
    try {
            ...
            Document doc = docBuilder.parse (new File("C:\\Users\\xprk791\\Desktop\\test.xml"));
            ...
            for(int s=0; s<listOfNotesBitMaps.getLength() ; s++){
                ...
                if(firstPersonNode.getNodeType() == Node.ELEMENT_NODE){
        			...
        			FileOutputStream imageOutFile = new FileOutputStream("C:\\Users\\xprk791\\Desktop\\"+ s +".bmp");
